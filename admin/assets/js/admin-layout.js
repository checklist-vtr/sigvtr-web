const AdminLayout=(()=>{
  ...
  const footer=`<div class="app-footer"><div>SIGVTR · Painel Administrativo 1.15.0 · 20º BPM/PMPA</div><div>Sugestões e melhorias: <a href="mailto:checklist.viaturas.oficial@gmail.com">checklist.viaturas.oficial@gmail.com</a></div></div>`;
  function init(){
