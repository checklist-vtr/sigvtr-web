const AdminLayout=(()=>{
  const VERSION="1.13.1-rc1";
  const sidebar=`<div class="sidebar-brand"><div class="sidebar-brand-icon"><img src="assets/images/brasao-20bpm.jpeg" alt="Brasão do 20º BPM"></div><div><strong>SIGVTR</strong><span>Gestão de Viaturas</span></div></div><nav class="sidebar-nav"><p class="sidebar-section-label">Principal</p><a class="sidebar-link" data-page="index.html" href="index.html"><i class="bi bi-grid-1x2-fill"></i><span>Dashboard</span></a><a class="sidebar-link" data-page="viaturas.html" href="viaturas.html"><i class="bi bi-truck-front-fill"></i><span>Viaturas</span></a><a class="sidebar-link" data-page="prontuario.html" href="prontuario.html"><i class="bi bi-journal-text"></i><span>Prontuário</span></a><a class="sidebar-link" data-page="checklists.html" href="checklists.html"><i class="bi bi-clipboard2-check-fill"></i><span>Checklists</span></a><a class="sidebar-link" data-page="usuarios.html" href="usuarios.html"><i class="bi bi-people-fill"></i><span>Usuários</span></a><a class="sidebar-link" data-page="avarias.html" href="avarias.html"><i class="bi bi-tools"></i><span>Avarias</span></a><a class="sidebar-link" data-page="relatorios.html" href="relatorios.html"><i class="bi bi-bar-chart-fill"></i><span>Relatórios</span></a><p class="sidebar-section-label">Sistema</p><a class="sidebar-link" data-page="configuracoes.html" href="configuracoes.html"><i class="bi bi-gear-fill"></i><span>Configurações</span></a></nav><div class="sidebar-footer"><button id="logoutButton" class="sidebar-link border-0 bg-transparent w-100 text-start"><i class="bi bi-box-arrow-right"></i><span>Sair</span></button></div>`;
  ...
  const footer=`<div class="app-footer"><div>SIGVTR · Painel Administrativo 1.13.1-rc1 · 20º BPM/PMPA</div><div>Sugestões e melhorias: <a href="mailto:checklist.viaturas.oficial@gmail.com">checklist.viaturas.oficial@gmail.com</a></div></div>`;
  function init(){
