const CACHE_NAME="sigvtr-fiscal-v11912rc1";
const OFFLINE_PAGE="./index.html?v=1.19.12-rc1";
const APP_FILES=[
 OFFLINE_PAGE,
 "./css/style.css?v=1.19.12-rc1",
 "./js/app.js?v=1.19.12-rc1",
 "./manifest.json?v=1.19.12-rc1",
